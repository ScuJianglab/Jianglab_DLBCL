...
class Launcher(TmuxLauncher):
    def common_options(self):
        return [
            # Command 0
            Options(
                dataroot="dataset/TrainValAB_all",
                name="HEIHC",
                #name="HE_IHC_round2",
                ...
                n_epochs=40,  # number of epochs with the initial learning rate
    ...
    def test_commands(self):
        ...
        phase = 'val'
        for opt in opts:
            opt.set(crop_size=1024, num_test=8000)
